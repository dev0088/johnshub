...
const PagesLoginContent = (props) => {
  ...
  const handleChangeUserInfo = (name, event) => {
    setUserInfo({
      ...userInfo,
                      ...
                      <Grid
                        ...
                        <span className="w-100 text-left text-md-center pb-4">
                          ...
                          <p className="font-size-lg text-xl-left text-center mb-0 text-black-50">
                            Sign in to enjoy benifits of johnshub vendor account.
                          </p>
                        </span>
                              ...
                              <div className="mb-3">
                                <FormControl className="w-100">
                                  ...
                                  <Input
                                    ...
                                    onChange={event => handleChangeUserInfo('email', event)}
                                  />
                                </FormControl>
                              </div>
                              <div className="mb-3">
                                <FormControl className="w-100">
                                  ...
                                  <Input
                                    ...
                                    onChange={event => handleChangeUserInfo('password', event)}
                                  />
                                </FormControl>
                              </div>
                              <div className="w-100">
...
export default PagesLoginContent;
